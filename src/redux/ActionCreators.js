...
export const postFeedback = (firstname, lastname, telnum, email, agree, contactType, message) =>(dispatch) => {
    ...
    .then(feedback => alert('The feedback received is - '+JSON.stringify(feedback)))
    .catch(error => {
        console.log('POST feedback error : '+error.message);
        alert('POST feedback error : '+error.message);
    })
...
// Leaders thunk and actions 

export const fetchLeaders = () => (dispatch) => {

    dispatch(leadersLoading()); //chk this for true as parameter
